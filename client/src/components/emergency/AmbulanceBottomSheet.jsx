        ...
        <div className="px-6 py-2 flex space-x-2 overflow-x-auto border-b border-gray-100">
          {['nearest', 'fastest', 'cheapest'].map(opt => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${sortBy === opt ? 'bg-black text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
            >
              ...
              >
                <div className="w-20 h-20 bg-gray-100 rounded-lg mr-4 flex flex-col items-center justify-center flex-shrink-0 relative overflow-hidden border border-gray-200">
                  <img
                    ...
                    alt="Ambulance"
                    className={`w-12 h-12 ${!amb.availability ? 'grayscale opacity-50'
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-1.5 mb-1 text-[10px] uppercase tracking-wider font-bold flex-wrap">
                        <span className={`px-1.5 py-0.5 rounded text-white ${amb.type === 'Mobile ICU' ? 'bg-red-500'
                    ...
                    <div className="flex flex-col items-end flex-shrink-0">
                      ...
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded mt-1 flex items-center ${amb.availability ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-500'
                        }`}>
